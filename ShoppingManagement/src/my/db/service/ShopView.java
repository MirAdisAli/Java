...
public class ShopView {
        ...
        public void ShopStart() {
                ...
                do{
                                ...
                                case "2":
                                        ...
                                        if(good!=null){
                                                System.out.println("Product number:"+goodId+" Trade name:"+good.getName()
                                                +"  product price:"+good.getPrice()+"  Quantity of products:"+good.getNum());
                                        }else{
        ...
        public void buyGood() {
                ...
                do{
                        ...
                        if(good!=null){
                                System.out.println("Enter quantity of products purchased");
                                int num = input.nextInt();
                                if(good.getNum()<num){
        ...
        private void updateGood() {
                ...
                if(good!=null){
                        System.out.println("Product number:"+gid+" Trade name:"+good.getName()
                        +"  product price:"+good.getPrice()+"  Quantity of products:"+good.getNum());
                        System.out.println("Modify product name");
                        String name = input.nextLine();
                        System.out.println("Modify product unit price");
                        float price = input.nextFloat();
                        input.nextLine();
                        System.out.println("Modify product inventory");
                        int num = input.nextInt();
                        input.nextLine();
